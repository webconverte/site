      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center relative z-10">
            <FadeIn className="lg:col-span-7">
              <div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-4 py-2 rounded-full mb-6 md:mb-8">
                ...
                <span className="text-white/80 text-sm font-medium tracking-wide uppercase">Alta Performance Digital</span>
              </div>
              <h1 className="font-headline text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-extrabold text-white leading-tight mb-6 md:mb-8 text-balance">
                Profissionais de Saúde e Beleza merecem uma <span className="text-secondary-fixed">agenda cheia.</span>
              </h1>
              ...
              <div className="flex items-center gap-4 sm:gap-8">
                <div className="flex items-center gap-2 sm:gap-3">
                  <span className="text-secondary-fixed font-bold text-xl sm:text-2xl">280+</span>
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  <span className="text-secondary-fixed font-bold text-xl sm:text-2xl">4.9</span>
                  <div className="flex flex-col">
                    ...
                    <span className="text-white/50 text-[10px] sm:text-sm">Avaliação Média</span>
                  </div>
                </div>
              </div>
            </FadeIn>
            <FadeIn delay={0.2} className="lg:col-span-5 relative">
              <div className="relative z-20 rounded-card overflow-hidden border-8 border-white/5 shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8 glass-card p-6 rounded-2xl">
                  <p className="text-secondary-fixed font-bold text-lg mb-1">Performance Real</p>
                  <p className="text-white/80 text-sm">Estruturas digitais que convertem curiosos em pacientes fidelizados.</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {[
                ...
                <FadeIn key={i} delay={i * 0.1}>
                  <div className="p-8 md:p-10 h-full bg-white rounded-card shadow-xl shadow-azul-noite/5 border-b-4 border-secondary/20 hover:border-secondary transition-all hover:-translate-y-2 group">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-12 md:mb-20">
              {[
                ...
                <FadeIn key={i} delay={i * 0.05}>
                  <div className="h-full p-5 sm:p-6 md:p-8 bg-surface-container-low rounded-2xl text-center hover:bg-azul-noite hover:text-white transition-all group">
        ...
        <section className="py-16 md:py-24 overflow-hidden relative bg-gradient-to-b from-[#0a1120] to-[#041847]">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 mb-12 md:mb-20 text-center relative z-20">
            <FadeIn>
              <h2 className="font-headline text-3xl md:text-5xl font-extrabold text-white">O caminho até você não é linear.</h2>
          ...
          <div className="w-full max-w-5xl mx-auto px-2 sm:px-4 md:px-8 relative">
            <FadeIn delay={0.2} className="relative w-full aspect-[4/5] sm:aspect-[4/3] md:aspect-[21/9]">
              ...
              {/* Decorative dots representing secondary interactions */}
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
            <FadeIn>
              <div className="flex flex-col lg:flex-row gap-0 rounded-[2.5rem] overflow-hidden shadow-2xl">
                ...
                {/* Resultados Práticos (Left Side - Light) */}
                ...
                {/* Resultados Emocionais (Right Side - Dark) */}
          ...
          <div className="max-w-5xl mx-auto px-4 md:px-8 relative z-10 text-center">
            <FadeIn>
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/70 mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed">
                Pare de depender de indicações. Dê o primeiro passo para ter uma equipe unida trabalhando dia e noite para lotar sua agenda.
              </p>
              ...
              {/* Sub-features / Trust */}
              <div className="mt-10 md:mt-14 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-10 text-white/50 text-xs sm:text-sm font-medium">
                <div className="flex items-center gap-2">
                  <Check className="w-4 h-4 md:w-5 md:h-5 text-secondary-fixed" />
                ...
                <div className="flex items-center gap-2">
                  <Check className="w-4 h-4 md:w-5 md:h-5 text-secondary-fixed" />
                  Foco em pacientes particulares
                </div>
              </div>
            </FadeIn>
          </div>
