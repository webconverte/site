...
import heroImage from '@/src/assets/images/maquiador_hero.png';
import {
  Menu,
  X,
  Scissors,
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center relative z-10">
            <FadeIn className="lg:col-span-7">
              <div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-4 py-2 rounded-full mb-6 md:mb-8">
                ...
                <span className="text-white/80 text-sm font-medium tracking-wide uppercase">Marketing para Maquiadores</span>
              </div>
              <h1 className="font-headline text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-extrabold text-white leading-tight mb-6 md:mb-8 text-balance">
                Maquiadores merecem ser <span className="text-secondary-fixed">a primeira opção em eventos especiais.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-10 md:mb-12">
                <a href="https://wa.me/5583986650650?text=Ol%C3%A1!%20Estava%20na%20p%C3%A1gina%20de%20Maquiadores%20e%20cliquei%20em%20%22Quero%20Mais%20Agendamentos%22.%20Gostaria%20de%20falar%20com%20um%20especialista!" target="_blank" rel="noopener noreferrer" className="bg-secondary-fixed text-azul-noite px-8 py-4 sm:px-10 sm:py-5 rounded-input font-bold text-base hover:shadow-[0_0_30px_rgba(192,243,102,0.3)] transition-all active:scale-95 gap-2 flex items-center justify-center text-center">
